...
export class LayersControl {
    ...
    public static mapContextMenuOptions = [
        {
            text: 'Recherche par parcelle',
            icon: 'dx-icon-find',
            code: 'FINDP',
            action: (e: any) => {
                console.log(e);
    ...
    public static ParcelLayersControl = {
        baseLayers: {
            ...
            'HERE hybridDay': tileLayer('https://{s}.{base}.maps.cit.api.here.com/maptile/2.1/{type}/' +
                ...
                subdomains: '1234',
                mapID: 'newest',
                app_id: 'FTEsTDxwfyL9NNlIyCOt',
                app_code: '2pAF3hGcPZ_OTj3sZg6naw',
                base: 'aerial',
                maxZoom: 20,
                type: 'maptile',
                language: 'eng',
